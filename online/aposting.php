...
if ($reply) {
  ...
  $text = "";
  echo "Alliance Forum: Reply to thread</th></tr>";
} else if ($edit) {
  ...
  echo "Aliance Forum: Edit Posting</th></tr>";
  
} else {
  $text = "";
  echo "Alliance Forum: New thread</th></tr>";
}

?>

<tr><td class="f2" width="80">Subject:</th>
<td width="420">
<?php
if (!$subject || $subject == "") {
...
<?php
  if($mysettings & 2) {
    if ($reply)
      echo "<a href=\"allforum.php?thread=$reply\">Return to thread</a>\n";
    else
      echo "<a href=\"allforum.php\">Return to Alliance Forum</a>\n";
  } else {
